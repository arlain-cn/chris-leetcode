...
public class TwoDCostPackMethod1Test {

    public static void main(String[] args) {
        PackageTemplate pt = new PackageTemplate();

        System.out.println("=== 二维费用背包问题测试 - 官方 twoDCostPackMethod1 ===");
        ...
        System.out.println("预期: 可以选择第1个物品(重量1,体积3,价值10)或第2个物品(重量1,体积4,价值20)或第3个物品(重量1,体积5,价值30)，最优选择第3个物品，价值30");
        System.out.println();
        ...
        System.out.println("预期: 只能选择第1个物品(重量6,体积1,价值10)，因为其他物品重量超过限制，价值30");
        System.out.println();
        ...
        System.out.println("预期: 选择第2个物品(重量3,体积3,价值5)，因为其他组合都不符合条件，价值6");
        System.out.println();
        ...
        System.out.println("=== 二维费用背包官方方法测试完成 ===");
    }
}